...
public class VectorSearchService {
    ...
    public List<ContentChunkWithDistance> search(String query, String original_field_name, int limit, List<String> tags, List<String> keywords, Map<String, Object> contextMap) throws IOException {
        ...
        return contentChunkRepository.findSimilar(queryVector, field_name, tagsArray, keywordsArray, contextMap, limit);
    }
}
